...
namespace Movies.APP.Features.Directors
{
    ...
    internal class DirectorDeleteHandler : Service<Director>, IRequestHandler<DirectorDeleteRequest, CommandResponse>
    {
        ...
        public async Task<CommandResponse> Handle(DirectorDeleteRequest request, CancellationToken cancellationToken)
        {
            ...
            if (entity.Movies.Count > 0) 
                return Error("Director can't be deleted because it has relational users!");
